...
val EnStrings = AppStrings(
    ...
    dialogAccept = "Accept",
    dialogCancel = "Cancel",
    fightReminderDialogMessage = "Turn on reminder for this fight.",
    fightReminderRemoveDialogMessage = "Turn off reminder for this fight.",
    notificationPermissionSettingsTitle = "Notification Permissions",
    notificationPermissionSettingsMessage = "Please enable notifications in your device settings.",
    fullScreenIntentSettingsTitle = "Alarm Permission Required",
    fullScreenIntentSettingsMessage = "Please enable full-screen alert permission in your device settings.",
    riskUnsure = "25 (Unsure)",
    ...
    settingsSectionSupport = "Support & Feedback",
    settingsSectionSupportSub = "clinchapp0@gmail.com",
    unblockUser = "Unblock",
    blockedUsersEmpty = "No blocked users.",
    menuSignInPrompt = "Follow your favorite fighters, earn points with predictions and get real-time event notifications.",
    menuTitle = "Menu",
    ...
    predictionConfirmMessage = { name -> "Confirm $name? Once locked, it cannot be changed and points will be calculated based on your selected risk." },
    leaderboardInfoTitle = "Score System",
    leaderboardInfoClose = "Close",
    tabOverall = "Overall",
    tabWeekly = "Weekly",
    notificationChannelName = "Fight Reminder",
    notificationChannelDescription = "Get notified before fights start.",
    commonRemove = "Remove",
    commonCancel = "Cancel",
    ...
    alarmFightTime = "FIGHT STARTING! 🔥",
    alarmDismiss = "DISMISS",
    notificationTypeTitle = "Reminder Type",
    notificationTypeMessage = "We'll send you a reminder right before the fight starts. Please select your notification type:\n\nNote: The Alarm feature is currently in Beta. For fights you absolutely cannot miss, we recommend setting your phone's native alarm as well.",
