...
val TrStrings = AppStrings(
    ...
    userSearchPlaceholder = "Kullanıcı ara...",
    userSearchEmpty = "Kullanıcı bulunamadı",
    retry = "Yenile",
    dialogAccept = "Onayla",
    dialogCancel = "Vazgeç",
    fightReminderDialogTitle = "Bu dövüş için hatırlatıcıyı aç",
    fightReminderDialogMessage = "Dövüş başlamadan hemen önce size bir bildirim göndereceğiz.",
    fightReminderRemoveDialogTitle = "Bu dövüş için hatırlatıcıyı kapat",
    notificationPermissionSettingsTitle = "Bildirim İzinleri",
    notificationPermissionSettingsMessage = "Lütfen cihaz ayarlarından bildirimleri etkinleştirin.",
    fullScreenIntentSettingsTitle = "Alarm İzni Gerekli",
    fullScreenIntentSettingsMessage = "Lütfen cihaz ayarlarından tam ekran uyarı iznini etkinleştirin.",
    ...
    tabOverall = "Genel",
    tabWeekly = "Haftalık",
    notificationChannelName = "Dövüş Hatırlatıcı",
    notificationChannelDescription = "Dövüş başlamadan önce bildirim al.",
    commonRemove = "Kaldır",
    commonCancel = "Vazgeç",
